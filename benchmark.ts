...
const isEqualTests: Array<{ description: string; tests: Array<{ description: string; value1: any; value2: any; equal: boolean }> }> = [
  {
    description: 'scalars',
    tests: [
      {
...

  {
    ...
    tests: [
      ...
      },
      {
        ...
        value1: new BigUint64Array(['1', '2', '3'] as any),
        value2: new BigUint64Array(['1', '2', '3'] as any),
        equal: true,
      },
      {
        description: 'not equal BigUint64Array arrays',
        value1: new BigUint64Array(['1', '2', '3'] as any),
        value2: new BigUint64Array(['1', '2', '4'] as any),
        equal: false,
      },
      {
