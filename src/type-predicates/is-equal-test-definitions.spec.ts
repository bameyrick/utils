...
export const isEqualTests: IsEqualTestSuite[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      {
        description: 'true and empty string',
        a: true,
        b: '',
        expected: false,
      },
      {
        description: 'true and null',
        a: true,
        b: null,
        expected: false,
      },
      {
        description: 'false and null',
        a: false,
        b: null,
        expected: false,
      },
      {
        description: 'true and undefined',
        a: true,
        b: undefined,
        expected: false,
      },
      {
        description: 'false and undefined',
        a: false,
        b: undefined,
        expected: false,
      },
